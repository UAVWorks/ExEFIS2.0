...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_panelWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_panelWidget_t qt_meta_stringdata_panelWidget = {
    {
QT_MOC_LITERAL(0, 0, 11), // "panelWidget"
QT_MOC_LITERAL(1, 12, 10), // "launchDiag"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "index"
QT_MOC_LITERAL(4, 30, 7), // "onTimer"
QT_MOC_LITERAL(5, 38, 12) // "onDebugTimer"

    },
    "panelWidget\0launchDiag\0\0index\0onTimer\0"
    "onDebugTimer"
};
...
void panelWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->launchDiag((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onTimer(); break;
        case 2: _t->onDebugTimer(); break;
        default: ;
        }
        ...
        {
            typedef void (panelWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&panelWidget::launchDiag)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject panelWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_panelWidget.data,
      qt_meta_data_panelWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *panelWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_panelWidget.stringdata))
...
// SIGNAL 0
void panelWidget::launchDiag(int _t1)
{
